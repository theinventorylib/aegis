...
SELECT id, user_id, organization_id, role, created_at, updated_at FROM members WHERE organization_id = ? ORDER BY created_at ASC;
...
-- name: ListTeams :many
SELECT id, organization_id, name, description, created_at, updated_at FROM team WHERE organization_id = ? ORDER BY created_at ASC;
...
SELECT id, team_id, user_id, role, created_at, updated_at FROM team_member WHERE team_id = ? ORDER BY created_at ASC;
