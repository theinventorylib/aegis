...
| `GET` | `/auth/oauth/link/:provider` | Link provider to existing account |
| `POST` | `/auth/oauth/unlink/:provider` | Unlink provider |
...
6. **Implement token refresh** - keep access tokens valid
